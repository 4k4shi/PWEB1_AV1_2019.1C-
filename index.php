...
<div class="container-contact100">
    <div class="wrap-contact100">
        <form class="contact100-form validate-form" action="atendimento/novo.php" method="POST">
            ...
            <div class="wrap-input100 bg1 rs1-wrap-input100">
                ...
                <label class="input100">
                    <input type="radio" name="tipo_cliente"> Novo cliente
                </label>
                <label class="input100">
                    <input type="radio" name="tipo_cliente"> Cliente antigo
                </label>
            </div>
            ...
            <div class="wrap-input100  bg0 ">
                ...
                <textarea class="input100" name="mensagem" placeholder="Escreva sua mensagem aqui..."></textarea>
            </div>
